...
export function pedRequestFromPatient(patient: Patient): PedRequest {
  return {
    ...
    addressProvinceCode: patient.address?.provinceCode,
    addressDistrictCode: patient.address?.districtCode,
    addressSubDistrictCode: patient.address?.subDistrictCode,
    ...
    addressBangkokZoneCode: patient.address?.bangkokZoneCode,
